...
export function DrinkCustomizer({ drink, onAddToCart, onCancel }: DrinkCustomizerProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="sticky top-16 bg-red-300 border-b border-gray-200 p-4 flex items-center justify-between z-10">
        <h2>{isSnack ? 'Customize Snack' : 'Customize Drink'}</h2>
      ...
      <div className="p-4">
        ...
        />
        <h2 className="text-gray-900 mb-2">{drink.name}</h2>
          ...
          <div className="grid grid-cols-2 gap-2">
            {coffeeStrengthOptions.map(strength => (
              <button
                ...
                className={`p-3 rounded-lg border-2 transition-all text-sm ${
                  customization.coffeeStrength === strength
                    ? 'border-amber-900 bg-amber-50 text-amber-900'
                    : 'border-gray-200 bg-white text-gray-700'
                }`}
              >
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <button
          ...
          className="w-full max-w-md mx-auto bg-amber-900 text-white py-4 rounded-lg hover:bg-amber-800 transition-colors flex items-center justify-between px-6"
        >
